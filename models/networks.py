...
class GlobalGenerator(nn.Module):
    ...
    def forward(self, input):
        ...
        H, W = self.inshape[2], self.inshape[3]
        # print("self.inshape: ", self.inshape)
        g_hyper = self.model(input)
        g_hyper = F.interpolate(g_hyper, size=[H, W], mode='bilinear', align_corners=True)
        # print("g_hyper shape: ", g_hyper.shape)  # torch.Size([1, 31, 482, 512])
        return g_hyper
